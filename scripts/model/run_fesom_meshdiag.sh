#!/bin/bash
#SBATCH --job-name=meshdiag_core3
#SBATCH --account=ab0246
#SBATCH --partition=compute
#SBATCH --ntasks=128
#SBATCH --time=00:30:00
#SBATCH --output=/work/bb1469/a270092/runtime/meshdiag_core3/meshdiag_%j.log
# Write fesom.mesh.diag.nc for the corrected CORE3 mesh with FESOM's fesom_meshdiag utility.
# FESOM only writes it on a cold start (fesom_module.F90: if (.not. r_restart)), and every
# coupled run since the mesh swap restarts, so no run has produced it.
# Modules and environment as in the generated comp-fesom_dp_script.sh; namelists from 15F.
module purge
...
cd /work/bb1469/a270092/runtime/meshdiag_core3
EXE=$(find /work/ab0246/a270092/model_codes/awiesm3-develop/fesom-2.7/build_meshdiag -name fesom_meshdiag -type f | head -1)
echo "running $EXE"
srun -n 128 $EXE
ls -la /work/bb1469/a270092/runtime/meshdiag_core3/*.mesh.diag.nc
